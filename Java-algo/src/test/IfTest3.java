...
public class IfTest3 {
	...
	public static void main(String[] args) {
		...
		if (ang1 > ang2 && ang1 > ang3 ) {
			...
			if (ang2 > ang3) {
				System.out.println(name2+"이 2등입니다.");
				System.out.println(name3+"이 3등입니다.");
			} else {
				System.out.println(name3+"이 2등입니다.");
				System.out.println(name2+"이 3등입니다.");
			}			
		} else if (ang2 > ang3 && ang2 > ang1) {
			System.out.println(name2+"이 1등입니다.");
			if (ang1 > ang3) {
				System.out.println(name1+"이 2등입니다.");
				System.out.println(name3+"이 3등입니다.");
			} else {
				System.out.println(name3+"이 2등입니다.");
				System.out.println(name1+"이 3등입니다.");
			}
